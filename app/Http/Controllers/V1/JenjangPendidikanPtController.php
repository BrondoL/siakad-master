...
class JenjangPendidikanPtController extends Controller
{
     ...
     *                      @OA\Property(property="max_cuti", type="integer", example=""),
     *                      @OA\Property(property="max_studi", type="integer", example=""),
     *                      @OA\Property(property="masa_studi", type="integer", example=""),
     *                      @OA\Property(property="default_nilai", type="decimal", example=""),
     *                      @OA\Property(property="kode_nim", type="string", example=""),
     *                      @OA\Property(property="kode_emis", type="string", example=""),
     *                      @OA\Property(property="kode_emis_pasca", type="string", example=""),
     *                      @OA\Property(property="deskripsi", type="string", example=""),
     *                      @OA\Property(property="is_pt", type="string", example=""),
     *                  ),
     *              ),
