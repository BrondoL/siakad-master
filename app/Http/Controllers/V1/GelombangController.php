...
class GelombangController extends Controller
{
     ...
     *      path="/v1/gelombang",
     *      tags={"Gelombang"},
     *      summary="List Gelombang",
     *      security={{"bearerAuth": {}}},
     *      @OA\Response(
     *          response=200,
     *          description="Get list of gelombang.",
     ...
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="select count(*) as aggregate from lv_gelombang"),
    ...
    /**
     * @OA\Get(
     *     path="/v1/gelombang/{id}",
     *     summary="Data Gelombang",
     *     tags={"Gelombang"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Get data of gelombang.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="SELECT * FROM lv_gelombang WHERE lv_gelombang.id = 1 limit 1"),
     *                      @OA\Property(property="time", type="integer", example=59.0),
     *                  ),
     *              ),
     *          ),
     ...
     *                          @OA\Property(property="message", type="string", example="No query results for model [App\Models\Gelombang] 1"),
     ...
     *     @OA\Response(
     *          response=201,
     *          description="Success add new gelombang.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="insert into lv_gelombang () values () returning id"),
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Success Update Gelombang.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="update lv_gelombang set lv_gelombang.id = 1 where lv_gelombang.id = 1"),
     *                      @OA\Property(property="time", type="integer", example=8.13),
     *                  ),
     *              ),
     *          ),
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Berhasil Menghapus Gelombang"
     *       ),
     *     @OA\Response(response=404, description="Error: Not Found",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="error", type="object",
