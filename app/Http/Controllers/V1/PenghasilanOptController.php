...
class PenghasilanOptController extends Controller
{
    /**
     *
     * @OA\Get(
     *      path="/v1/penghasilan-opt",
     *      tags={"Penghasilan opt"},
     *      summary="List Penghasilan opt",
     *      security={{"bearerAuth": {}}},
     *      @OA\Response(
     *          response=200,
     *          description="Get list of penghasilan opt.",
     ...
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="select count(*) as aggregate from lv_penghasilan_opt"),
    ...
    /**
     * @OA\Get(
     *     path="/v1/penghasilan-opt/{id}",
     *     summary="Data Penghasilan opt",
     *     tags={"Penghasilan opt"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         description="id penghasilan opt",
     *         in="path",
     *         name="id",
     *         required=true,
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Get data of penghasilan opt.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=1),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="SELECT * FROM lv_penghasilan_opt WHERE lv_penghasilan_opt.id = 1 limit 1"),
     *                      @OA\Property(property="time", type="integer", example=59.0),
     *                  ),
     *              ),
     *          ),
     ...
     *                          @OA\Property(property="message", type="string", example="No query results for model [App\Models\PenghasilanOpt] 1"),
     ...
     *     @OA\Response(
     *          response=201,
     *          description="Success add new penghasilan opt.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=1),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="insert into lv_penghasilan_opt () values () returning id"),
     ...
     * @OA\Put(
     *     path="/v1/penghasilan-opt/{id}",
     *     summary="Update penghasilan opt",
     *     tags={"Penghasilan opt"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         description="id penghasilan opt",
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Success Update Penghasilan opt.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=1),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="update lv_penghasilan_opt set lv_penghasilan_opt.id = 1 where lv_penghasilan_opt.id = 1"),
     *                      @OA\Property(property="time", type="integer", example=8.13),
     *                  ),
     *              ),
     *          ),
     ...
     * @OA\Delete(
     *     path="/v1/penghasilan-opt/{id}",
     *     summary="Delete penghasilan opt",
     *     tags={"Penghasilan opt"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         description="id penghasilan opt",
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Berhasil Menghapus Penghasilan opt"
     *       ),
     *     @OA\Response(response=404, description="Error: Not Found",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="error", type="object",
