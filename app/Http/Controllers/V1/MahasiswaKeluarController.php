...
class MahasiswaKeluarController extends Controller
{
     ...
     *                      @OA\Property(property="id_mahasiswa_pt", type="integer", example=""),
     *                      @OA\Property(property="id_periode", type="integer", example=""),
     *                      @OA\Property(property="id_status", type="integer", example=""),
     *                      @OA\Property(property="tgl_sk", type="date", example=""),
     *                      @OA\Property(property="no_sk", type="string", example=""),
     *                      @OA\Property(property="id_file_sk", type="guid", example=""),
     *                  ),
     *              ),
