...
class JabatanFungsionalController extends Controller
{
     ...
     *
     * @OA\Get(
     *      path="/v1/jabatan-fungsional",
     *      tags={"Jabatan fungsional"},
     *      summary="List Jabatan fungsional",
     *      security={{"bearerAuth": {}}},
     *      @OA\Response(
     *          response=200,
     *          description="Get list of jabatan fungsional.",
     ...
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="select count(*) as aggregate from ms_jabatan_fungsional"),
    ...
    /**
     * @OA\Get(
     *     path="/v1/jabatan-fungsional/{id}",
     *     summary="Data Jabatan fungsional",
     *     tags={"Jabatan fungsional"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         description="id jabatan fungsional",
     *         in="path",
     *         name="id",
     *         required=true,
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Get data of jabatan fungsional.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="SELECT * FROM ms_jabatan_fungsional WHERE ms_jabatan_fungsional.id = 1 limit 1"),
     *                      @OA\Property(property="time", type="integer", example=59.0),
     *                  ),
     *              ),
     *          ),
     ...
     *                          @OA\Property(property="message", type="string", example="No query results for model [App\Models\JabatanFungsional] 1"),
     ...
     * @OA\Post(
     *     path="/v1/jabatan-fungsional",
     *     summary="Add Jabatan fungsional",
     *     tags={"Jabatan fungsional"},
     *     security={{"bearerAuth": {}}},
     *     @OA\RequestBody(
     *         @OA\MediaType(
     ...
     *     @OA\Response(
     *          response=201,
     *          description="Success add new jabatan fungsional.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="insert into ms_jabatan_fungsional () values () returning id"),
     ...
     * @OA\Put(
     *     path="/v1/jabatan-fungsional/{id}",
     *     summary="Update jabatan fungsional",
     *     tags={"Jabatan fungsional"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         description="id jabatan fungsional",
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Success Update Jabatan fungsional.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="update ms_jabatan_fungsional set ms_jabatan_fungsional.id = 1 where ms_jabatan_fungsional.id = 1"),
     *                      @OA\Property(property="time", type="integer", example=8.13),
     *                  ),
     *              ),
     *          ),
     ...
     * @OA\Delete(
     *     path="/v1/jabatan-fungsional/{id}",
     *     summary="Delete jabatan fungsional",
     *     tags={"Jabatan fungsional"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         description="id jabatan fungsional",
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Berhasil Menghapus Jabatan fungsional"
     *       ),
     *     @OA\Response(response=404, description="Error: Not Found",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="error", type="object",
