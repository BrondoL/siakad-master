...
class StatusPegawaiController extends Controller
{
     ...
     *
     * @OA\Get(
     *      path="/v1/status-pegawai",
     *      tags={"Status pegawai"},
     *      summary="List Status pegawai",
     *      security={{"bearerAuth": {}}},
     *      @OA\Response(
     *          response=200,
     *          description="Get list of status pegawai.",
     ...
     *                      @OA\Property(property="is_keluar", type="string", example=""),
     *                  ),
     *              ),
     ...
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="select count(*) as aggregate from lv_status_pegawai"),
    ...
    /**
     * @OA\Get(
     *     path="/v1/status-pegawai/{id}",
     *     summary="Data Status pegawai",
     *     tags={"Status pegawai"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         description="id status pegawai",
     *         in="path",
     *         name="id",
     *         required=true,
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Get data of status pegawai.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="SELECT * FROM lv_status_pegawai WHERE lv_status_pegawai.id = 1 limit 1"),
     *                      @OA\Property(property="time", type="integer", example=59.0),
     *                  ),
     *              ),
     *          ),
     ...
     *                          @OA\Property(property="message", type="string", example="No query results for model [App\Models\StatusPegawai] 1"),
     ...
     *     @OA\Response(
     *          response=201,
     *          description="Success add new status pegawai.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="insert into lv_status_pegawai () values () returning id"),
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Success Update Status pegawai.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="update lv_status_pegawai set lv_status_pegawai.id = 1 where lv_status_pegawai.id = 1"),
     *                      @OA\Property(property="time", type="integer", example=8.13),
     *                  ),
     *              ),
     *          ),
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Berhasil Menghapus Status pegawai"
     *       ),
     *     @OA\Response(response=404, description="Error: Not Found",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="error", type="object",
