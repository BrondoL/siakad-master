...
class BidangIlmuPtController extends Controller
{
    /**
     *
     * @OA\Get(
     *      path="/v1/bidang-ilmu-pt",
     *      tags={"Bidang ilmu pt"},
     *      summary="List Bidang ilmu pt",
     *      security={{"bearerAuth": {}}},
     *      @OA\Response(
     *          response=200,
     *          description="Get list of bidang ilmu pt.",
     ...
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="select count(*) as aggregate from lv_bidang_ilmu_pt"),
    ...
    /**
     * @OA\Get(
     *     path="/v1/bidang-ilmu-pt/{id}",
     *     summary="Data Bidang ilmu pt",
     *     tags={"Bidang ilmu pt"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         description="id bidang ilmu pt",
     *         in="path",
     *         name="id",
     *         required=true,
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Get data of bidang ilmu pt.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=1),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="SELECT * FROM lv_bidang_ilmu_pt WHERE lv_bidang_ilmu_pt.id = 1 limit 1"),
     *                      @OA\Property(property="time", type="integer", example=59.0),
     *                  ),
     *              ),
     *          ),
     ...
     *                          @OA\Property(property="message", type="string", example="No query results for model [App\Models\BidangIlmuPt] 1"),
     ...
     *     @OA\Response(
     *          response=201,
     *          description="Success add new bidang ilmu pt.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=1),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="insert into lv_bidang_ilmu_pt () values () returning id"),
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Success Update Bidang ilmu pt.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=1),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="update lv_bidang_ilmu_pt set lv_bidang_ilmu_pt.id = 1 where lv_bidang_ilmu_pt.id = 1"),
     *                      @OA\Property(property="time", type="integer", example=8.13),
     *                  ),
     *              ),
     *          ),
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Berhasil Menghapus Bidang ilmu pt"
     *       ),
     *     @OA\Response(response=404, description="Error: Not Found",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="error", type="object",
