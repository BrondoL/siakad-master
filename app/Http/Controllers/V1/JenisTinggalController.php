...
class JenisTinggalController extends Controller
{
     ...
     *
     * @OA\Get(
     *      path="/v1/jenis-tinggal",
     *      tags={"Jenis tinggal"},
     *      summary="List Jenis tinggal",
     *      security={{"bearerAuth": {}}},
     *      @OA\Response(
     *          response=200,
     *          description="Get list of jenis tinggal.",
     ...
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="select count(*) as aggregate from lv_jenis_tinggal"),
    ...
    /**
     * @OA\Get(
     *     path="/v1/jenis-tinggal/{id}",
     *     summary="Data Jenis tinggal",
     *     tags={"Jenis tinggal"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         description="id jenis tinggal",
     *         in="path",
     *         name="id",
     *         required=true,
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Get data of jenis tinggal.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=1),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="SELECT * FROM lv_jenis_tinggal WHERE lv_jenis_tinggal.id = 1 limit 1"),
     *                      @OA\Property(property="time", type="integer", example=59.0),
     *                  ),
     *              ),
     *          ),
     ...
     *                          @OA\Property(property="message", type="string", example="No query results for model [App\Models\JenisTinggal] 1"),
     ...
     *     @OA\Response(
     *          response=201,
     *          description="Success add new jenis tinggal.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=1),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="insert into lv_jenis_tinggal () values () returning id"),
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Success Update Jenis tinggal.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=1),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="update lv_jenis_tinggal set lv_jenis_tinggal.id = 1 where lv_jenis_tinggal.id = 1"),
     *                      @OA\Property(property="time", type="integer", example=8.13),
     *                  ),
     *              ),
     *          ),
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Berhasil Menghapus Jenis tinggal"
     *       ),
     *     @OA\Response(response=404, description="Error: Not Found",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="error", type="object",
