...
class PenghasilanController extends Controller
{
     ...
     *      path="/v1/penghasilan",
     *      tags={"Penghasilan"},
     *      summary="List Penghasilan",
     *      security={{"bearerAuth": {}}},
     *      @OA\Response(
     *          response=200,
     *          description="Get list of penghasilan.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     *                      @OA\Property(property="kode_penghasilan", type="integer", example=""),
     *                      @OA\Property(property="nama_penghasilan", type="string", example=""),
     *                      @OA\Property(property="poin_bidik_misi", type="integer", example=""),
     *                  ),
     *              ),
     ...
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="select count(*) as aggregate from lv_penghasilan"),
    ...
    /**
     * @OA\Get(
     *     path="/v1/penghasilan/{id}",
     *     summary="Data Penghasilan",
     *     tags={"Penghasilan"},
     *     security={{"bearerAuth": {}}},
     *     @OA\Parameter(
     *         description="id penghasilan",
     *         in="path",
     *         name="id",
     *         required=true,
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Get data of penghasilan.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="SELECT * FROM lv_penghasilan WHERE lv_penghasilan.id = 1 limit 1"),
     *                      @OA\Property(property="time", type="integer", example=59.0),
     *                  ),
     *              ),
     *          ),
     ...
     *                          @OA\Property(property="message", type="string", example="No query results for model [App\Models\Penghasilan] 1"),
     ...
     *     @OA\Response(
     *          response=201,
     *          description="Success add new penghasilan.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="insert into lv_penghasilan () values () returning id"),
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Success Update Penghasilan.",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="data", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="id", type="integer", example=""),
     ...
     *              @OA\Property(property="debug", type="array",
     *                  @OA\Items(type="object",
     *                      @OA\Property(property="query", type="string", example="update lv_penghasilan set lv_penghasilan.id = 1 where lv_penghasilan.id = 1"),
     *                      @OA\Property(property="time", type="integer", example=8.13),
     *                  ),
     *              ),
     *          ),
     ...
     *     @OA\Response(
     *          response=200,
     *          description="Berhasil Menghapus Penghasilan"
     *       ),
     *     @OA\Response(response=404, description="Error: Not Found",
     *          @OA\JsonContent(type="object",
     *              @OA\Property(property="error", type="object",
