...
class SistemKuliahController extends Controller
{
     ...
     *                      @OA\Property(property="kode_sistem", type="integer", example=""),
     *                      @OA\Property(property="nama_sistem", type="string", example=""),
     *                      @OA\Property(property="keterangan", type="string", example=""),
     *                      @OA\Property(property="is_reguler", type="string", example=""),
     *                  ),
     *              ),
